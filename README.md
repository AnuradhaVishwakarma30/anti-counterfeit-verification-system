# BrandProtekt | SaaS Anti-Counterfeit Dashboard 🛡️
...
## 📈 Future Roadmap
- **Node.js Backend:** Transitioning from LocalStorage to a secure MongoDB/PostgreSQL database.
- **Camera Integration:** Using the browser's camera API to allow actual QR code scanning.
- **Blockchain Verification:** Exploring immutable ledger technology for high-end luxury brand protection.
